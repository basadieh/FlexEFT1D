...
def main():
	...
	#plt.xlabel('Time (Day)')
	plt.title('Daily Surface Rate of Detritus Formation in Continuous Model')
	...
	#plt.xlabel('Time (Day)')
	plt.title('Daily Surface Rate of Zooplankton Formation in Continuous Model')
        month_vec = np.tile(['Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan'], 1)
        plt.xticks(np.arange(0, 450, 30), month_vec)
	plt.axis([0, len(plot_params), 0, max(plot_params)+0.1*(max(plot_params))])
	...
	plt.xlabel('Time (Day)')
	plt.title('Daily Surface Rate of Phytoplankton Formation in Continuous Model')
        month_vec = np.tile(['Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan'], 1)
        plt.xticks(np.arange(0, 450, 30), month_vec)
	plt.axis([0, len(plot_params), 0, max(plot_params)+0.1*(max(plot_params))])
